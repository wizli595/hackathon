...
var CalendarPanel = React7.forwardRef(function(props, ref) {
  var cx = props.cx;
  var mergeProps = useMergeProps();
...
var Calendar = React7.memo(React7.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  ...
  var _React$useState3 = React7.useState(false), _React$useState4 = _slicedToArray(_React$useState3, 2), overlayVisibleState = _React$useState4[0], setOverlayVisibleState = _React$useState4[1];
  var _React$useState5 = React7.useState(null), _React$useState6 = _slicedToArray(_React$useState5, 2), viewDateState = _React$useState6[0], setViewDateState = _React$useState6[1];
  var _React$useState7 = React7.useState(props.id), _React$useState8 = _slicedToArray(_React$useState7, 2), idState = _React$useState8[0], setIdState = _React$useState8[1];
  var metaData = {
    props,
    state: {
  ...
  var navigation = React7.useRef(null);
  var ignoreFocusFunctionality = React7.useRef(false);
  var timePickerTimer = React7.useRef(null);
  var viewStateChanged = React7.useRef(false);
  var touchUIMask = React7.useRef(null);
  var overlayEventListener = React7.useRef(null);
  var touchUIMaskClickListener = React7.useRef(null);
  var isOverlayClicked = React7.useRef(false);
  var previousButton = React7.useRef(false);
  var nextButton = React7.useRef(false);
  var viewChangedWithKeyDown = React7.useRef(false);
  var onChangeRef = React7.useRef(null);
  var isClearClicked = React7.useRef(false);
  var _React$useState9 = React7.useState("date"), _React$useState10 = _slicedToArray(_React$useState9, 2), currentView = _React$useState10[0], setCurrentView = _React$useState10[1];
  var _React$useState11 = React7.useState(null), _React$useState12 = _slicedToArray(_React$useState11, 2), currentMonth = _React$useState12[0], setCurrentMonth = _React$useState12[1];
  var _React$useState13 = React7.useState(null), _React$useState14 = _slicedToArray(_React$useState13, 2), currentYear = _React$useState14[0], setCurrentYear = _React$useState14[1];
  var _React$useState15 = React7.useState([]), _React$useState16 = _slicedToArray(_React$useState15, 2), yearOptions = _React$useState16[0], setYearOptions = _React$useState16[1];
  ...
  var createBackwardNavigator = function createBackwardNavigator2(isVisible) {
    ...
    var icon2 = props.prevIcon || React7.createElement(ChevronLeftIcon, previousIconProps);
    var backwardNavigatorIcon = IconUtils.getJSXIcon(icon2, _objectSpread3({}, previousIconProps), {
      props
    });
    ...
    var previousButtonProps = mergeProps(_objectSpread3({
      type: "button",
      className: cx("previousButton"),
      "aria-label": previousButtonLabel
    }, navigatorProps), ptm("previousButton"));
    return React7.createElement("button", _extends7({
      ref: previousButton
    }, previousButtonProps), backwardNavigatorIcon, React7.createElement(Ripple, null));
  };
  var createForwardNavigator = function createForwardNavigator2(isVisible) {
    ...
    var icon2 = props.nextIcon || React7.createElement(ChevronRightIcon, nextIconProps);
    var forwardNavigatorIcon = IconUtils.getJSXIcon(icon2, _objectSpread3({}, nextIconProps), {
      props
    });
    ...
    var nextButtonProps = mergeProps(_objectSpread3({
      type: "button",
    ...
    return React7.createElement("button", _extends7({
      ref: nextButton
    }, nextButtonProps), forwardNavigatorIcon, React7.createElement(Ripple, null));
  };
  ...
  var createTitleMonthElement = function createTitleMonthElement2(month2, monthIndex) {
    ...
    if (renderMonthsNavigator(monthIndex)) {
      ...
      var _content = React7.createElement("select", selectProps, displayedMonthOptions.map(function(option) {
        var optionProps = mergeProps({
          value: option.value
        }, ptm("option"));
        return React7.createElement("option", _extends7({}, optionProps, {
          key: option.label
        }), option.label);
      }));
    ...
    return currentView === "date" && React7.createElement("button", monthTitleProps, monthNames[month2]);
  };
  var createTitleYearElement = function createTitleYearElement2(metaYear) {
    ...
    if (props.yearNavigator) {
      ...
      var _content2 = React7.createElement("select", selectProps, displayedYearNames.map(function(year2) {
        var optionProps = mergeProps({
          value: year2
        }, ptm("option"));
        return React7.createElement("option", _extends7({}, optionProps, {
    ...
    return currentView !== "year" && React7.createElement("button", yearTitleProps, displayYear);
  };
  var createTitleDecadeElement = function createTitleDecadeElement2() {
    ...
    if (currentView === "year") {
      ...
      return React7.createElement("span", decadeTitleProps, props.decadeTemplate ? props.decadeTemplate(years) : React7.createElement("span", decadeTitleTextProps, "".concat(yearPickerValues()[0], " - ").concat(yearPickerValues()[yearPickerValues().length - 1])));
    }
    return null;
  };
  var createTitle = function createTitle2(monthMetaData, index) {
    ...
    return React7.createElement("div", titleProps, showMonthAfterYear ? year2 : month2, showMonthAfterYear ? month2 : year2, decade);
  };
  var createDayNames = function createDayNames2(weekDays) {
    ...
    var dayNames = weekDays.map(function(weekDay, index) {
      return React7.createElement("th", _extends7({}, tableHeaderCellProps, {
        key: "".concat(weekDay, "-").concat(index)
      }), React7.createElement("span", weekDayProps, weekDay));
    });
    if (props.showWeek) {
      ...
      var weekHeader = React7.createElement("th", _extends7({}, weekHeaderProps, {
        key: "wn"
      }), React7.createElement("span", weekLabel, localeOption("weekHeader", props.locale)));
  ...
  var createDateCellContent = function createDateCellContent2(date, className, groupIndex) {
    ...
    return React7.createElement("span", dayLabelProps, content2, selected && React7.createElement("div", {
      "aria-live": "polite",
  ...
  var createWeek = function createWeek2(weekDates, weekNumber, groupIndex) {
    var week = weekDates.map(function(date) {
      ...
      return React7.createElement("td", _extends7({}, dayProps, {
        key: date.day
      }), content2);
    });
    if (props.showWeek) {
      ...
      var weekNumberCell = React7.createElement("td", _extends7({}, weekNumberProps, {
        key: "wn" + weekNumber
      }), React7.createElement("span", weekLabelContainerProps, weekNumber));
  ...
  var createDates = function createDates2(monthMetaData, groupIndex) {
    ...
    return monthMetaData.dates.map(function(weekDates, index) {
      return React7.createElement("tr", _extends7({}, tableBodyRowProps, {
        key: index
  ...
  var createDateViewGrid = function createDateViewGrid2(monthMetaData, weekDays, groupIndex) {
    ...
    return currentView === "date" && React7.createElement("div", containerProps, React7.createElement("table", tableProps, React7.createElement("thead", tableHeaderProps, React7.createElement("tr", tableHeaderRowProps, dayNames)), React7.createElement("tbody", tableBodyProps, dates)));
  };
  var createMonth = function createMonth2(monthMetaData, index) {
    ...
    return React7.createElement("div", _extends7({}, groupProps, {
      key: monthKey
    }), React7.createElement("div", headerProps, header, backwardNavigator, title, forwardNavigator), dateViewGrid);
  };
  var createMonths = function createMonths2(monthsMetaData) {
    ...
    return React7.createElement("div", groupContainerProps, groups);
  };
  ...
  var createMonthYearView = function createMonthYearView2() {
    ...
    return React7.createElement(React7.Fragment, null, React7.createElement("div", groupContainerProps, React7.createElement("div", groupProps, React7.createElement("div", headerProps, backwardNavigator, React7.createElement("div", titleProps, yearElement, decade), forwardNavigator))));
  };
  ...
  var incrementIcon = IconUtils.getJSXIcon(props.incrementIcon || React7.createElement(ChevronUpIcon, incrementIconProps), _objectSpread3({}, incrementIconProps), {
    props
  });
  var decrementIcon = IconUtils.getJSXIcon(props.decrementIcon || React7.createElement(ChevronDownIcon, decrementIconProps), _objectSpread3({}, decrementIconProps), {
    props
  });
  var createHourPicker = function createHourPicker2() {
    ...
    return React7.createElement("div", hourPickerProps, React7.createElement("button", incrementButtonProps, incrementIcon, React7.createElement(Ripple, null)), React7.createElement("span", hourProps, hourDisplay), React7.createElement("button", decrementButtonProps, decrementIcon, React7.createElement(Ripple, null)));
  };
  var createMinutePicker = function createMinutePicker2() {
    ...
    return React7.createElement("div", minutePickerProps, React7.createElement("button", incrementButtonProps, incrementIcon, React7.createElement(Ripple, null)), React7.createElement("span", minuteProps, minuteDisplay), React7.createElement("button", decrementButtonProps, decrementIcon, React7.createElement(Ripple, null)));
  };
  var createSecondPicker = function createSecondPicker2() {
    if (props.showSeconds) {
      ...
      return React7.createElement("div", secondPickerProps, React7.createElement("button", incrementButtonProps, incrementIcon, React7.createElement(Ripple, null)), React7.createElement("span", secondProps, secondDisplay), React7.createElement("button", decrementButtonProps, decrementIcon, React7.createElement(Ripple, null)));
    }
    return null;
  };
  var createMiliSecondPicker = function createMiliSecondPicker2() {
    if (props.showMillisec) {
      ...
      return React7.createElement("div", millisecondPickerProps, React7.createElement("button", incrementButtonProps, incrementIcon, React7.createElement(Ripple, null)), React7.createElement("span", millisecondProps, millisecondDisplay), React7.createElement("button", decrementButtonProps, decrementIcon, React7.createElement(Ripple, null)));
    }
    return null;
  };
  var createAmPmPicker = function createAmPmPicker2() {
    if (props.hourFormat === "12") {
      ...
      return React7.createElement("div", ampmPickerProps, React7.createElement("button", incrementButtonProps, incrementIcon, React7.createElement(Ripple, null)), React7.createElement("span", ampmProps, display), React7.createElement("button", decrementButtonProps, decrementIcon, React7.createElement(Ripple, null)));
    }
    return null;
  };
  var createSeparator = function createSeparator2(separator) {
    ...
    return React7.createElement("div", separatorContainerProps, React7.createElement("span", separatorProps, separator));
  };
  var createTimePicker = function createTimePicker2() {
    if ((props.showTime || props.timeOnly) && currentView === "date") {
      ...
      return React7.createElement("div", timePickerProps, createHourPicker(), createSeparator(":"), createMinutePicker(), props.showSeconds && createSeparator(":"), createSecondPicker(), props.showMillisec && createSeparator("."), createMiliSecondPicker(), props.hourFormat === "12" && createSeparator(":"), createAmPmPicker());
    }
    return null;
  };
  var createInputElement = function createInputElement2() {
    if (!props.inline) {
      return React7.createElement(InputText, {
        ref: inputRef,
        id: props.inputId,
        name: props.name,
        type: "text",
  ...
  var createButton = function createButton2() {
    if (props.showIcon) {
      return React7.createElement(Button, {
        type: "button",
        icon: props.icon || React7.createElement(CalendarIcon, null),
  ...
  var createContent = function createContent2() {
    ...
    if (props.iconPos === "left") {
      return React7.createElement(React7.Fragment, null, button, input2);
    }
    return React7.createElement(React7.Fragment, null, input2, button);
  };
  var createButtonBar = function createButtonBar2() {
    if (props.showButtonBar) {
      ...
      return React7.createElement("div", buttonbarProps, React7.createElement(Button, {
        type: "button",
  ...
  var createFooter = function createFooter2() {
    if (props.footerTemplate) {
      ...
      return React7.createElement("div", footerProps, _content3);
    }
    return null;
  };
  var createMonthPicker = function createMonthPicker2() {
    if (currentView === "month") {
      ...
      return React7.createElement("div", monthPickerProps, monthPickerValues().map(function(m, i) {
        ...
        return React7.createElement("span", _extends7({}, monthProps, {
          key: "month".concat(i + 1)
        }), m, selected && React7.createElement("div", {
          "aria-live": "polite",
          className: "p-hidden-accessible",
          "data-p-hidden-accessible": true,
          pt: ptm("hiddenMonth")
  ...
  var createYearPicker = function createYearPicker2() {
    if (currentView === "year") {
      ...
      return React7.createElement("div", yearPickerProps, yearPickerValues().map(function(y, i) {
        ...
        return React7.createElement("span", _extends7({}, yearProps, {
          key: "year".concat(i + 1)
        }), y, selected && React7.createElement("div", {
          "aria-live": "polite",
          className: "p-hidden-accessible",
          "data-p-hidden-accessible": true,
          pt: ptm("hiddenYear")
  ...
  return React7.createElement("span", _extends7({
    ref: elementRef
  }, rootProps), content, React7.createElement(CalendarPanel, {
    hostName: "Calendar",
    id: panelId,
    locale: props.locale,
    ref: overlayRef,
